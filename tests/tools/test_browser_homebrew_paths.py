...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_injects_agent_browser_args_for_apparmor_userns(self, tmp_path):
        """Ubuntu/AppArmor local Chromium fallback should use agent-browser's args env."""
        captured_env = {}
